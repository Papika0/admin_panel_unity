...
import { AddPersonModalButton } from "@/components/Button";
...
<template>
  <h2 class="mt-10 text-lg font-medium intro-y">პერონალი</h2>
  <div class="grid grid-cols-12 gap-6 mt-5">
    <div
      class="flex flex-wrap items-center col-span-12 mt-2 intro-y sm:flex-nowrap"
    >
      <AddPersonModalButton />
      <!-- <Button variant="primary" class="mr-2 shadow-md">
        დაამატეთ ახალი პიროვნება
      </Button> -->
      <Button variant="outline-secondary" class="mr-2 shadow-md">
        ექსპორტი
